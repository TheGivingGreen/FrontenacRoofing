 ...
 */
const PROJECTS = [
  { span: "pg1", type: "Commercial", location: "[City, ST]", title: "[Project title]", ratio: "3-2" as const },
  { span: "pg2", type: "Residential", location: "[City, ST]", title: "[Project title]", ratio: "4-5" as const },
  { span: "pg3", type: "Specialty", location: "[City, ST]", title: "[Project title]", ratio: "4-3" as const },
  { span: "pg4", type: "Commercial", location: "[City, ST]", title: "[Project title]", ratio: "3-2" as const },
];
      ...
      <div className="container container--editorial">
        ...
        <div className={styles.projectGrid}>
          {PROJECTS.map((p, i) => (
            ...
            >
              <ImageSlot ratio={p.ratio} label={`${p.type} project — approved photo`} />
